...
class MeowBottomNavigation : FrameLayout {
    ...
    var globalCircleSize = 64f.dp(context)
    var Profundidade_Bezier = -1f

    var Largura_Bezier = -1f
    ...
    private fun setAttributeFromXml(context: Context, attrs: AttributeSet) {
        ...
        try {
            a.apply {
                ...
                globalCircleSize =
                    getDimension(R.styleable.MeowBottomNavigation_mbn_circleSize, globalCircleSize)

                Profundidade_Bezier =
                    getDimension(R.styleable.MeowBottomNavigation_mbn_profundidade_bezier, Profundidade_Bezier)

                Largura_Bezier =
                    getDimension(R.styleable.MeowBottomNavigation_mbn_largura_bezier, Largura_Bezier)

                Curva_Bezier =
                    getDimension(R.styleable.MeowBottomNavigation_mbn_curva_bezier, Curva_Bezier)
        ...
        heightCell = (150.dp(context) * (globalCircleSize/64f.dp(context))).toInt()
    }
    ...
    private fun initializeViews() {
        ...
        bezierView.apply {
            ...
            profundidade_bezier = Profundidade_Bezier
            largura_bezier = Largura_Bezier
            curvinha = Curva_Bezier
        }
